...
const createUpload = <TData = AxiosResponse<Upload>>(
    createUploadRequest: CreateUploadRequest, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
const cancelUpload = <TData = AxiosResponse<Upload>>(
    ...
    return axios.default.post(
      `/uploads/${uploadId}/cancel`,undefined,options
    );
  }
/**
...
const addUploadPart = <TData = AxiosResponse<UploadPart>>(
    uploadId: string,
    addUploadPartRequest: AddUploadPartRequest, options?: AxiosRequestConfig
