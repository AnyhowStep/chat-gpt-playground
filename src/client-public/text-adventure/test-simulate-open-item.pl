...
test(box, all(X=[
    ...
    simulateOpenItem(character('Alice'), item('BoxA'), Success, Texts, Mutations),
...
test(box, all(X=[
    ...
    simulateOpenItem(character('Alice'), item('Apple'), Success, Texts, Mutations),
    X = [
        Success, Texts, Mutations
    ].
