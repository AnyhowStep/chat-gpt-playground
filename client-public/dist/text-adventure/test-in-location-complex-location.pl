:- begin_tests(inLocation, [
    setup((
        ...
        setLocation(item('Apple'), location('LivingRoom')),
        ...
        setLocation(item('Cupboard'), location('LivingRoom')),
    ...
    cleanup((
        ...
        retract_all_with_term('Apple'),
        retract_all_with_term('Alice'),
        retract_all_with_term('Pear'),
        retract_all_with_term('Box')
    ))
]).
...
test(appleInStreet, all(X = [location('Street')])) :-
    setLocation(item('Apple'), location('Street')),
    inLocation(item('Apple'), X).
